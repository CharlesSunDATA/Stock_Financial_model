...
pg = st.navigation(
    [
        ...
        st.Page("1_Quarterly_financials.py", title="Quarterly financials"),
        st.Page("markowitz_portfolio.py", title="Markowitz optimization"),
        st.Page("2_Technical_Strategy_Backtester.py", title="Technical backtester"),
        st.Page("3_Earnings_Call_NLP_Analyzer.py", title="Earnings call NLP"),
    ]
)
