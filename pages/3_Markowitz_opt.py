...
def main() -> None:
    ...
    # 10 well-diversified tickers across sectors for meaningful frontier:
    # Tech: NVDA, AAPL, MSFT  |  Healthcare: JNJ  |  Financials: JPM
    # Consumer: AMZN           |  Energy: XOM       |  Industrials: CAT
    # Bonds: TLT (rate hedge)  |  Gold: GLD (inflation hedge)
